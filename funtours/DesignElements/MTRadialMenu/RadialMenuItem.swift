...
//  funtours
//
//  Created by Catharina Herchert on 09.10.17.
...
class RadialMenuItem : MTMenuItem {
    
    var colorNormal = UIColor.hippieBlue()
    var colorSelected = UIColor.smaltBlue()
    var fillColor3 = UIColor.white
    ...
    override func draw(_ rect: CGRect) {
        ...
        (self.isSelected ? colorSelected : colorNormal).setFill()
