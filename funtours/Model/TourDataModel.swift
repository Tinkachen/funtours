...
class TourData: Equatable {
    ...
    init(identifier: String?, tourName: String?, tourDescription: String?, creator: String?, creationTime: String?, image: UIImage?, likes: Int?, favs: Int?, comments: [Comments]?, stations: [Stations]?) {
